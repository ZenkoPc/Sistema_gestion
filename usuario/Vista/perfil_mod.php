					...
					<div class="offcanvas offcanvas-start bg-dark" style="color:white;" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
						...
						<div class="offcanvas-body">
							...
							<div class="collapse" id="seccion3">
								<br />
								<div class="card card-body bg-dark" style="border:0px;padding:0px;">
									<h6><a href="manual.php" class="links">
											<span>
												<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-caret-right" viewBox="0 0 16 16">
													<path d="M6 12.796V3.204L11.481 8 6 12.796zm.659.753 5.48-4.796a1 1 0 0 0 0-1.506L6.66 2.451C6.011 1.885 5 2.345 5 3.204v9.592a1 1 0 0 0 1.659.753z" />
												</svg>
				...
				<div class="container-fluid">
					...
					<nav style="background:#FBF8F9;" aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Modificar Informacion</li>
						</ol>
					</nav>
					<div class="container">
						<h1 class="offset-xl-1" id="h1Inicio"><strong>Dasyos S.A </strong></h1>
						<h3 class="offset-xl-1">Perfil del Empleado:</h3>
						<h4 class="offset-xl-1">Modificar Datos:</h4>
						<form action="../Controlador/editar.php" class="col-xl-9 offset-xl-1" method="POST" style="background:#FEFBFA;border:2px solid;">
							<fieldset>
								<div class="card" style="border:1px solid">
									<div class="card-header">
										<div class="row mb-3 justify-content-center">
											<img src="../../img/usuario.jpg" class="rounded-circle img-fluid col-sm-4" style="width:180px;height:150px;">
											<h4 class="col-sm-4"><br /> <br />
												<?php
												echo $emp->Nombre_emp . " " . $emp->Apellido_emp
												?>
											</h4>
										</div>
									</div>
									<div class="card-body" style="background:#B2E666;">
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-4">
												...
												<input type="hidden" name="id" value="<?php echo $emp->id_empleado ?>">
												<label for="nombre" class="form-label">Nombres:</label>
												<input class="form-control" type="text" name="nombre" value="<?php echo $emp->Nombre_emp ?>" required autocomplete="off">
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-4">
												<label for="apellido" class="form-label">Apellidos:</label>
												<input class="form-control" type="text" name="apellido" value="<?php echo $emp->Apellido_emp ?>" required autocomplete="off">
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-4 col-lg-4 offset-lg-1 col-xl-3">
												<label for="documento" class="form-label">Documento:</label>
												<input class="form-control" type="hidden" name="documento" value="<?php echo $emp->Documento_emp ?>" required autocomplete="off" >
												<input class="form-control" type="text" value="<?php echo $emp->Documento_emp ?>" required autocomplete="off" disabled>
											</div>
											<div class="col-xs-12 col-sm-4 col-lg-3 col-xl-3">
												<label for="edad" class="form-label">Edad:</label>
												<input class="form-control" type="number" name="edad" value="<?php echo $emp->Edad_emp ?>" required autocomplete="off">
											</div>
											<div class="col-xs-12 col-sm-4 col-lg-3 col-xl-3">
												<label for="Salario" class="form-label">Salario:</label>
												<input name="Salario" value="<?php echo $emp->Salario_emp ?>" type="hidden">
												<input class="form-control" type="number" value="<?php echo $emp->Salario_emp ?>" disabled>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-4">
												<label for="direccion" class="form-label">Direccion:</label>
												<input class="form-control" type="text" name="direccion" value="<?php echo $emp->Direccion_emp ?>" required autocomplete="off">
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-4">
												<label for="correo" class="form-label">correo:</label>
												<input class="form-control" type="email" name="correo" value="<?php echo $emp->Correo_emp ?>" required autocomplete="off">
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-4 offset-lg-2 col-xl-3 offset-xl-1">
												<label for="telefono" class="form-label">Telefono:</label>
												<input class="form-control" type="text" name="telefono" value="<?php echo $emp->Telefono_emp ?>" required autocomplete="off">
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-4 col-xl-3">
												<label for="Horario" class="form-label">Horario:</label>
												<input name="Horario" value="<?php echo $emp->Horario_emp ?>" type="hidden">
												<input class="form-control" type="text" value="<?php echo $emp->Horario_emp ?>" disabled>
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-3">
												<label for="Area" class="form-label">Area:</label>
												<input name="Area" value="<?php echo $emp->Area_emp ?>" type="hidden">
												<input class="form-control" type="text" value="<?php echo $emp->Area_emp ?>" disabled>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-5">
												<label for="Profesion" class="form-label">Profesion:</label>
												<input name="Profesion" value="<?php echo $emp->Profesion_emp ?>" type="hidden">
												<input class="form-control" type="text" value="<?php echo $emp->Profesion_emp ?>" disabled>
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-3">
												<label for="Dias_descanso" class="form-label">Dias de descanso:</label>
												<input name="Dias_descanso" value="<?php echo $emp->Diasdes_emp ?>" type="hidden">
												<input class="form-control" type="text" value="<?php echo $emp->Diasdes_emp ?>" disabled>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-7">
												<label for="Funciones" class="form-label">Funciones:</label>
												<input name="Funciones" value="<?php echo $emp->Funciones_emp ?>" type="hidden">
												<textarea class="form-control" disabled><?php echo $emp->Funciones_emp ?>
						    </textarea>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-3">
												...
												<input name="Contraseña" type="hidden" value="<?php echo $emp->Contraseña_usuario ?>">
												<input class="form-control" type="text" value="<?php echo $emp->Contraseña_usuario ?>" disabled>
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-3">
												<label for="Educativo" class="form-label">Nivel Educativo:</label>
												<input name="Educativo" type="hidden" value="<?php echo $emp->NivelEducativo_emp ?>">
												<input class="form-control" type="text" value="<?php echo $emp->NivelEducativo_emp ?>" disabled>
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-3">
												<label for="Cargo" class="form-label">Cargo:</label>
												<input name="Cargo" type="hidden" value="<?php echo $emp->Cargo_emp ?>">
												<input class="form-control" type="text" value="<?php echo $emp->Cargo_emp ?>" disabled>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-4">
												<label for="Admin1" class="form-label">Administrador:</label>
												<input name="Admin1" value="<?php echo $emp->Admin ?>" type="hidden">
											...
											<div class="col-xs-12 col-sm-6 col-lg-6 col-xl-4">
												...
												<input name="Estado" value="<?php echo $emp->Estado_emp ?>" type="hidden">
												<select class="form-select" disabled>
													<?php

													if ($emp->Estado_emp == "activo") {
													?>
												...
												<input name="elim" value="<?php echo $_SESSION['user'] ?>" type="hidden">
												<input name="doc" value="<?php echo $emp->Documento_emp ?>" type="hidden">
											</div>
										</div>
										<br />
									</div>
			...
			<div class="container text-center text-md-start mt-5">
				<div class="row mt-3">
					...
					<div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
						...
						<p>
							<a href="archivos.php" class="text-reset">Archivos</a>
						</p>
						<p>
