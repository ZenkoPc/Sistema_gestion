			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse justify-content-end" id="navbr">
					<ul class="nav navbar-nav">
						...
						<li class="nav-item">
							<a href="#" class="btn btn-default boton nav-link">
								<span>
			...
			<article class="col-xs-12 col-sm-10 col-md-9 col-lg-9 col-xl-10" id="fondoCentral">
				<div class="container-fluid">
					...
					<div class="container">
						...
						<h4 class="offset-xl-1">Ver Informacion del Empleado:</h4>
						<form action="perfil_mod.php" class="col-xl-9 offset-xl-1" style="background:#FEFBFA;border:2px solid;">
							<fieldset>
								<div class="card" style="border:1px solid">
									<div class="card-header">
										<div class="row mb-3 justify-content-center">
											<img src="../../img/usuario.jpg" class="rounded-circle img-fluid col-sm-4" style="width:180px;height:150px;">
											<h5 class="col-sm-4"><br />
												<?php echo $emp->Nombre_emp . " " . $emp->Apellido_emp ?>
												<br />
												<?php if ($emp->Admin == "si") {
													echo "Administrador";
												} else {
												...
												?>
												<br />
												Cargo: <?php echo $emp->Cargo_emp ?>
												<br />
												Estado: <?php echo $emp->Estado_emp ?>
												<br />
											</h5>
										</div>
									</div>
									<div class="card-body" style="background:#B2E666;">
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-4">
												<input type="hidden" value="<?php echo $emp->id_empleado ?>" name="id">
												<label for="Nombre" class="form-label">Nombres:</label>
												<input class="form-control" type="text" name="nombre" value="<?php echo $emp->Nombre_emp ?>" disabled>
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-4">
												<label for="Apellido" class="form-label">Apellidos:</label>
												<input class="form-control" type="text" name="apellido" value="<?php echo $emp->Apellido_emp ?>" disabled>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-4 col-lg-4 offset-lg-1 col-xl-3">
												<label for="Documento" class="form-label">Documento:</label>
												<input class="form-control" type="text" name="documento" value="<?php echo $emp->Documento_emp ?>" disabled>
											</div>
											<div class="col-xs-12 col-sm-4 col-lg-3 col-xl-3">
												<label for="Edad" class="form-label">Edad:</label>
												<input class="form-control" type="number" name="edad" value="<?php echo $emp->Edad_emp ?>" disabled>
											</div>
											<div class="col-xs-12 col-sm-4 col-lg-3 col-xl-3">
												<label for="Salario" class="form-label">Salario:</label>
												<input class="form-control" type="number" name="salario" value="<?php echo $emp->Salario_emp ?>" disabled>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-4">
												<label for="Direccion" class="form-label">Direccion:</label>
												<input class="form-control" type="text" name="direccion" value="<?php echo $emp->Direccion_emp ?>" disabled>
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-4">
												<label for="Correo" class="form-label">Correo:</label>
												<input class="form-control" type="email" name="correo" value="<?php echo $emp->Correo_emp ?>" disabled>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-4 offset-lg-2 col-xl-3 offset-xl-1">
												<label for="Telefono" class="form-label">Telefono:</label>
												<input class="form-control" type="text" name="telefono" value="<?php echo $emp->Telefono_emp ?>" disabled>
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-4 col-xl-3">
												<label for="Horario" class="form-label">Horario:</label>
												<input class="form-control" type="text" name="Horario" value="<?php echo $emp->Horario_emp ?>" disabled>
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-3">
												<label for="Area" class="form-label">Area:</label>
												<input class="form-control" type="text" name="Area" value="<?php echo $emp->Area_emp ?>" disabled>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-5">
												<label for="Profesion" class="form-label">Profesion:</label>
												<input class="form-control" type="text" name="Profesion" value="<?php echo $emp->Profesion_emp ?>" disabled>
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-3">
												<label for="Dias_descanso" class="form-label">Dias de descanso:</label>
												<input class="form-control" type="text" name="Dias_descanso" value="<?php echo $emp->Diasdes_emp ?>" disabled>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-7">
												<label for="Funciones" class="form-label">Funciones:</label>
												<textarea name="Funciones" class="form-control" disabled><?php echo $emp->Funciones_emp ?>
						    </textarea>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-4">
												...
												<input name="Contraseña" class="form-control" type="text" value="<?php echo $emp->Contraseña_usuario ?>" disabled>
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-4">
												<label for="Educativo" class="form-label">Nivel Educativo:</label>
												<input name="Educativo" class="form-control" type="text" value="<?php echo $emp->NivelEducativo_emp ?>" disabled>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-4">
												<label for="Admin1" class="form-label">Administrador:</label>
												<select name="Admin1" class="form-select" disabled>
													<?php
													if ($emp->Admin == "si") {
													?>
			...
			<div class="container text-center text-md-start mt-5">
				<div class="row mt-3">
					...
					<div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
						...
						<p>
							<a href="#" class="text-reset">Informacion Personal</a>
						</p>
						<p>
