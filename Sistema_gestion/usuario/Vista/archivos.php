...
$sql2 = "select id_archivo, Nombre_arc, Tipo_arc, Peso_arc, Dueño_arc,Nombre_temp, Fecha_sub,Documento_emp , Nombre_emp, Apellido_emp from archivos, empleado where Documento_emp='$_SESSION[user]' and id_empleado=Dueño_arc ";
			...
			<article class="col-xs-12 col-sm-10 col-md-9 col-lg-9 col-xl-10" id="fondoCentral">
				<div class="container-fluid">
					...
					<div class="container">
						...
						<h3 class="offset-lg-1">Archivos del empleado:</h3>
						<form class="offset-lg-1" action="archivos.php" class="navbar-form me-auto" method="POST">
							<div class="row">
								<div class="col-auto">
						...
						<div class="row">
							<div class="table-responsive col-xs-10 offset-lg-1 col-lg-11  col-xl-10 scrol2">
								<table class="table table-striped table-bordered table-hover" style="border:2px solid;">
									...
									<tbody style="background:#FAF5F7;">
										...
										if ($id == 1) {
											...
											$sql0=$objCon->prepare("select id_empleado from empleado where Documento_emp='$_SESSION[user]'");
											$sql0->execute();
											$res0=$sql0->get_result();
											$emp0=$res0->fetch_object();

											$nombre = preg_replace('/(?<!\\\)([%_])/', '\\\$1', $nombre); #necesario para que el bind_param no lo dañe
											$sql3 = $objCon->prepare("select * from archivos where Nombre_arc LIKE CONCAT('%',?,'%') and Dueño_arc=?");
											$sql3->bind_param('ss', $nombre,$emp0->id_empleado);
											$sql3->execute();
										...
										if ($id == 2) {
											...
											$nombre = preg_replace('/(?<!\\\)([%_])/', '\\\$1', $nombre); #necesario para que el bind_param no lo dañe
											$sql3 = $objCon->prepare("select * from archivos where Tipo_arc LIKE CONCAT('%',?,'%') and Dueño_arc=?");
											$sql3->bind_param('ss', $nombre,$emp0->id_empleado);
											$sql3->execute();
											$res3 = $sql3->get_result();
