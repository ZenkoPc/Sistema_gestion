...
if (!isset($_SESSION['user']))
	header("Location: ../../login.php?x=2"); #x=2 debe iniciar sesion
...
if ($emp->Admin == "no") {
	header("Location: ../../usuario/Vista/index.php?x=1"); #x=1 no puede acceder a esta pagina
}
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse justify-content-end" id="navbr">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown-divider"></li>
						<li class="nav-item">
							<a href="#" class="btn btn-info boton nav-link active">
								<span>
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
										<path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
										<path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z" />
				...
				<div class="container-fluid">
					...
					<nav style="background:#FBF8F9;" aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="perfil_admin.php">Ver Perfil</a></li>
					...
					<div class="container">
						...
						<h4>Modificar Datos:</h4><br />
						<form action="../Controlador/editar.php" method="POST" class="col-xl-9 offset-xl-1" style="background:#FEFBFA;border:2px solid;">
							<fieldset>
									...
									<div class="card-body" style="background:#B2E666;">
										...
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-4 col-lg-4 offset-lg-1 col-xl-3">
												...
												<input class="form-control" type="text" name="Documento" value="<?php echo $emp->Documento_emp ?>" required autocomplete="off">
											</div>
