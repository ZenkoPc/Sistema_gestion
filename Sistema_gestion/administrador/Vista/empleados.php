...
if ($_SERVER["REQUEST_METHOD"] == "POST") #sdetecta si la peticion es post yo lo puse por un error en pantalla xddddd
	$nombre = $_POST['nombre'];
...
if (!isset($_SESSION['user']))
	header("Location: ../../login.php?x=2"); #x=2 debe estar logueados

if ($user->Admin == "no") {
	header("Location: ../../usuario/Vista/index.php?x=1"); #x=1 el usuario no tiene permisos para acceder a esta area
}
				...
				<div class="container-fluid">
					...
					<div class="offcanvas offcanvas-start bg-dark" style="color:white;" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
						<div class="offcanvas-header bg-light" style="color:black;">
							...
							<h3><?php echo $user->Nombre_emp . " " . $user->Apellido_emp ?></h3>
				...
				<div class="container-fluid">
					...
					<nav style="background:#FBF8F9;" aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Ver empleados:</li>
						</ol>
					</nav>
					<div class="container-fluid">
						<h1 id="h1Inicio"><strong>Dasyos S.A</strong></h1>
						<h3>Empleados totales:</h3>
						<form action="empleados.php" method="post" class="navbar-form me-auto">
							<div class="row">
								<div class="col-auto">
								...
								<div class="col-auto">
									<div class="input-group">
										...
										if($id==2){
											...
											<option value="0">Seleccione</option>
											<option value="1">Nombre</option>
											<option value="2" selected>Cargo</option>
											<option value="3">Documento</option>
											<option value="4">Profesion</option>
											<?php
										}
										...
										if($id==3){
											...
											<option value="1">Nombre</option>
											<option value="2">Cargo</option>
											<option value="3" selected>Documento</option>
											<option value="4">Profesion</option>
											<?php
										}
										?>
										...
										if($id==4){
											...
											<option value="2">Cargo</option>
											<option value="3">Documento</option>
											<option value="4" selected>Profesion</option>
											<?php
										}
										?>
								...
								<div class="col-auto">
									...
									<a href="../Controlador/filtrar.php?valor=99" class="btn btn-success links">Limpiar Filtro</a>
								</div>
							</div>
						</form>
						<!--simbolos-->
						...
						?>
							<div class="alert alert-danger d-flex align-items-center alert-dismissible fade show" role="alert">
								...
								<div>
									Ha ocurrido un error durante la creacion del empleado
									<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
								</div>
							</div>
						<?php
						...
						?>
							<div class="alert alert-success d-flex align-items-center alert-dismissible fade show" role="alert">
								...
								<div>
									Se ha actualizado correctamente los datos del empleado
									<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
								</div>
							</div>
						<?php
						...
						?>
							<div class="alert alert-danger d-flex align-items-center alert-dismissible fade show" role="alert">
								...
								<div>
									Ha ocurrido un error durante la actualizacion de datos del empleado
									<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
								</div>
							</div>
						<?php
						...
						?>
							<div class="alert alert-success d-flex align-items-center alert-dismissible fade show" role="alert">
								...
								<div>
									Se ha eliminado correctamente los datos del empleado
									<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
								</div>
							</div>
						<?php
						...
						?>
							<div class="alert alert-danger d-flex align-items-center alert-dismissible fade show" role="alert">
								...
								<div>
									Ha ocurrido un error durante la eliminacion de datos del empleado
									<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
								</div>
							</div>
						<?php
						...
						?>
							<div class="alert alert-danger d-flex align-items-center alert-dismissible fade show" role="alert">
								...
								<div>
									Error: No se puede editar su mismo perfil
									<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
								</div>
							</div>
						<?php
						...
						?>
							<div class="alert alert-success d-flex align-items-center alert-dismissible fade show" role="alert">
								...
								<div>
									El perfil fue actualizado de forma satisfactoria
									<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
								</div>
							</div>
						<?php
						...
						?>
							<div class="alert alert-danger d-flex align-items-center alert-dismissible fade show" role="alert">
								...
								<div>
									Error: Ocurrio un error durante la actualizacion de datos
									<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
								</div>
							</div>
						<?php
						...
						<div class="row">
							<div class="table-responsive col-xs-12  col-lg-11  col-xl-11 scrol2">
								<table class="table table-striped table-bordered table-hover" style="border:2px solid;">
									<thead>
										<tr class="table-active table-success ">
											...
											<th class="col-xs-4">Edad</th>
											<th class="col-xs-4">Salario</th>
											<th class="col-xs-4">Direccion</th>
											<th class="col-xs-4">Correo</th>
											<th class="col-xs-4">Telefono</th>
											<th class="col-xs-4">Horario</th>
											<th class="col-xs-4">Estado</th>
											<th class="col-xs-4">Cargo</th>
											<th class="col-xs-4">Area</th>
											<th class="col-xs-4">Funciones</th>
											<th class="col-xs-4">Profesion</th>
											<th class="col-xs-4">Dias de descanso</th>
											<th class="col-xs-4">Contraseña</th>
											<th class="col-xs-4">Nivel Educativo</th>
											<th class="col-xs-4">Fecha Afiliacion</th>
											<th class="col-xs-4">Administrador</th>
									...
									<tbody style="background:#FAF5F7;">
										...
										?>
												<tr>
													...
													<td><?php echo $emp->Documento_emp ?></td>
													<td><?php echo $emp->Edad_emp ?></td>
													<td><?php echo $emp->Salario_emp ?></td>
													<td><?php echo $emp->Direccion_emp ?></td>
													<td><?php echo $emp->Correo_emp ?></td>
													<td><?php echo $emp->Telefono_emp ?></td>
													<td><?php echo $emp->Horario_emp ?></td>
													<td><?php echo $emp->Estado_emp ?></td>
													<td><?php echo $emp->Cargo_emp ?></td>
													<td><?php echo $emp->Area_emp ?></td>
													<td><?php echo $emp->Funciones_emp ?></td>
													<td><?php echo $emp->Profesion_emp ?></td>
													<td><?php echo $emp->Diasdes_emp ?></td>
													<td><?php echo $emp->Contraseña_usuario ?></td>
													<td><?php echo $emp->NivelEducativo_emp ?></td>
													<td><?php echo $emp->FechaAfiliacion_emp ?></td>
													<td><?php echo $emp->Admin ?></td>
													<td>
														<a href="empleado_mod.php?id=<?php echo $emp->id_empleado ?>&x=1" class="links">Modificar</a>,
														<a href="empleado_del.php?id=<?php echo $emp->id_empleado ?>$x=1" class="links">Eliminar</a>,
														<a href="archivos_admin_sub.php?id=<?php echo $emp->id_empleado ?>&x=1&Doc=<?php echo $emp->Documento_emp ?>" class="links">Agregar Archivo</a>
													</td>
												</tr>
										<?php
											}
										...
										if ($id == 1) {
											...
											$sql3 = $objCon->prepare("select * from empleado where Nombre_emp LIKE CONCAT('%',?,'%') order by Nombre_emp ");
											$sql3->bind_param('s', $nombre);
											$sql3->execute();
											$res3 = $sql3->get_result();
											while ($emp = $res3->fetch_object()) {
										?>
												<tr>
													<td><?php echo $emp->id_empleado ?></td>
													<td><?php echo $emp->Nombre_emp ?></td>
													...
													<td><?php echo $emp->Admin ?></td>
													<td>
														<a href="empleado_mod.php?id=<?php echo $emp->id_empleado ?>" class="links">Modificar</a>,
														<a href="empleado_del.php?id=<?php echo $emp->id_empleado ?>" class="links">Eliminar</a>,
														<a href="archivos_admin_sub.php?id=<?php echo $emp->id_empleado ?>&x=1&Doc=<?php $emp->Documento_emp ?>" class="links">Agregar Archivo</a>
													</td>
												</tr>
										<?php
											}
										...
										if ($id == 2) {
											$nombre = preg_replace('/(?<!\\\)([%_])/', '\\\$1', $nombre); #necesario para que el bind_param no lo dañe
											$sql3 = $objCon->prepare("select * from empleado where Cargo_emp LIKE CONCAT('%',?,'%') order by Cargo_emp");
											$sql3->bind_param('s', $nombre);
											$sql3->execute();
											$res3 = $sql3->get_result();
											while ($emp = $res3->fetch_object()) {
										?>
												<tr>
													...
													<td>
														<a href="empleado_mod.php?id=<?php echo $emp->id_empleado ?>" class="links">Modificar</a>,
														<a href="empleado_del.php?id=<?php echo $emp->id_empleado ?>" class="links">Eliminar</a>,
														<a href="archivos_admin_sub.php?id=<?php echo $emp->id_empleado ?>" class="links">Agregar Archivo</a>
													</td>
												</tr>
										<?php
											}
										...
										if ($id == 3) {
											$nombre = preg_replace('/(?<!\\\)([%_])/', '\\\$1', $nombre); #necesario para que el bind_param no lo dañe
											$sql3 = $objCon->prepare("select * from empleado where Documento_emp LIKE CONCAT('%',?,'%') order by Documento_emp");
											$sql3->bind_param('s', $nombre);
											$sql3->execute();
											$res3 = $sql3->get_result();
											while ($emp = $res3->fetch_object()) {
										...
										if ($id == 4) {
											$nombre = preg_replace('/(?<!\\\)([%_])/', '\\\$1', $nombre); #necesario para que el bind_param no lo dañe
											$sql3 = $objCon->prepare("select * from empleado where Profesion_emp LIKE CONCAT('%',?,'%') order by Profesion_emp");
											$sql3->bind_param('s', $nombre);
											$sql3->execute();
											$res3 = $sql3->get_result();
											while ($emp = $res3->fetch_object()) {
						...
						<br />
						<left>
							<a href="empleado_new.php" class="btn btn-success btn-lg">Crear Empleado</a>
							<a href="index_admin.php" class="btn btn-success btn-lg">Volver al Menu</a>
						</left>
					</div>
					<br />
				</div>
