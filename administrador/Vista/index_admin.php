...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar-dark static-top bg-dark">
			<div class="container-fluid">
				<div class="navbar-header">
					<a id="Barra" href="#" class="navbar-brand me-auto">
	...
	<section class="container-fluid bg-light">
		<div class="main row">
				...
				<div class="container-fluid">
					...
					<div class="offcanvas offcanvas-start bg-dark" style="color:white;" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
						<div class="offcanvas-header bg-light" style="color:black;">
							...
							<h3><?php echo $user->Nombre_emp." ".$Apellido_emp ?></h3>
			...
			<article class="col-xs-12 col-sm-10 col-md-9 col-lg-10 col-xl-10 img-fluid" id="fondoCentral">
				<div class="container-fluid">
					<br />
					...
					<div class="container">
						...
						<div class="row">
							<div class="table-responsive col-xs-10 offset-xs-1 col-lg-10  col-xl-10 scrol">
								<table class="table table-striped table-bordered table-hover" style="border:2px solid;">
									...
									<tbody style="background:#FAF5F7;">
											<?php
											    ...
											    $sql2=$objCon->prepare("select id_empleado,Nombre_emp,Apellido_emp,Profesion_emp,Horario_emp,Estado_emp from empleado where Estado_emp='activo' order by Nombre_emp");
												$sql2->execute();
												...
												while($emp=$res2->fetch_object()){
													...
													?>
                                                        ...
                                                        <tr>
														    ...
														    <td class="col-xs-4"><?php echo $emp->Estado_emp ?></td>
												        </tr>
							...
							<div class="table-responsive col-xs-10 offset-xs-1 col-lg-10 col-xl-10 scrol">
								<table class="table table-striped table-bordered table-hover" style="border:2px solid;">
									...
									<?php
									    ...
									    $sql3=$objCon->prepare("select id_empleado,Nombre_emp,Apellido_emp,Profesion_emp,Horario_emp,Diasdes_emp from empleado order by Nombre_emp");
										$sql3->execute();
										$res3=$sql3->get_result();

										while($emp2=$res3->fetch_object()){

											?>

                                            <tr>
											    <td class="col-xs-4"><?php echo $emp2->id_empleado ?></td>
												<td class="col-xs-4"><?php echo $emp2->Nombre_emp." ".$emp2->Apellido_emp ?></td>
												<td class="col-xs-4"><?php echo $emp2->Profesion_emp ?></td>
												<td class="col-xs-4"><?php echo $emp2->Horario_emp ?></td>
												<td class="col-xs-4"><?php echo $emp2->Diasdes_emp ?></td>
										    </tr>
