			...
			<article class="col-xs-12 col-sm-10 col-md-9 col-lg-9 col-xl-10 img-fluid" id="fondoCentral">
				<div class="container-fluid">
					...
					<div class="container">
						...
						<h3 class="offset-xl-1">Perfil del Administrador:</h3>
						<h4 class="offset-xl-1">Ver Informacion del Administrador:</h4><br />
						<form action="perfil_admin_mod.php" class="col-xl-9 offset-xl-1" style="background:#FEFBFA;border:2px solid;">
							<fieldset>
