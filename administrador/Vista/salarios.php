				...
				<div class="container-fluid">
					...
					<div class="offcanvas offcanvas-start bg-dark" style="color:white;" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
						...
						<div class="offcanvas-body">
							...
							<div class="collapse show" id="seccion4">
								<br />
								<div class="card card-body bg-dark" style="border:0px;padding:0px;">
				...
				<div class="container-fluid">
					...
					<nav style="background:#FBF8F9;" aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Ver Salarios:</li>
						</ol>
					</nav>
					<div class="container">
						<h1 id="h1Inicio"><strong>Dasyos S.A</strong></h1>
						<h3>Salarios de los Empleados:</h3>
						<form action="salarios.php" class="navbar-form me-auto" role="search">
							<div class="row">
								<div class="col-auto">
									...
									<div class="input-group">
										...
										<select name="id" class="form-select">
											...
											if($id==2){
												...
												<option value="0">Seleccione</option>
												<option value="1">Nombre</option>
											    <option value="2" selected>Profesion</option>
											    <option value="3">Salario</option>
												<?php
											}
											?>
											...
											if($id==3){
												...
												<option value="1">Nombre</option>
											    <option value="2">Profesion</option>
											    <option value="3" selected>Salario</option>
												<?php
											}
											?>
										</select>
								...
								<div class="col-auto">
									...
									<a href="../Controlador/filtrar.php?valor=97" class="btn btn-success links">Limpiar Filtro</a>
								</div>
							</div>
						</form>
						<div class="row">
							<div class="table-responsive col-xs-10 offset-xs-1 col-lg-11  col-xl-10 scrol2">
								<!--simbolos-->
								...
								?>
									<div class="alert alert-warning d-flex align-items-center alert-dismissible fade show" role="alert">
										...
										<div>
											Se mostraran los Valores menores o iguales al Salario colocado
								...
								<table class="table table-striped table-bordered table-hover" style="border:2px solid;">
									...
									<tbody style="background:#FAF5F7;">
										...
										if ($id == 0) {
											...
											$sql2 = $objCon->prepare("select id_empleado,Nombre_emp,Apellido_emp,Profesion_emp,Salario_emp,Horario_emp from empleado");
											$sql2->execute();
										...
										?>
												...
												<tr>
													<td class="col-xs-4"><?php echo $emp->id_empleado ?></td>
													<td class="col-xs-4"><?php echo $emp->Nombre_emp . " " . $emp->Apellido_emp ?></td>
													<td class="col-xs-4"><?php echo $emp->Profesion_emp ?></td>
													<td class="col-xs-4"><?php echo $emp->Salario_emp ?></td>
													<td class="col-xs-4"><?php echo $emp->Horario_emp ?></td>
												</tr>
										...
										if ($id == 1) {
											...
											$sql2 = $objCon->prepare("select id_empleado,Nombre_emp,Apellido_emp,Profesion_emp,Salario_emp,Horario_emp from empleado where Nombre_emp like CONCAT('%',?,'%')");
											$sql2->bind_param("s", $nombre);
											$sql2->execute();
											$res2 = $sql2->get_result();
										...
										if ($id == 2) {
											...
											$sql2 = $objCon->prepare("select id_empleado,Nombre_emp,Apellido_emp,Profesion_emp,Salario_emp,Horario_emp from empleado where Profesion_emp like CONCAT('%',?,'%')");
											$sql2->bind_param("s", $nombre);
											$sql2->execute();
											$res2 = $sql2->get_result();
										...
										if ($id == 3) {
											...
											$sql2 = $objCon->prepare("select id_empleado,Nombre_emp,Apellido_emp,Profesion_emp,Salario_emp,Horario_emp from empleado where Salario_emp<= ?");
											$sql2->bind_param("s", $nombre);
											$sql2->execute();
											$res2 = $sql2->get_result();
