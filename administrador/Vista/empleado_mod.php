...
$sql2 = "select * from empleado where id_empleado='$_REQUEST[id]'";

$res = $objCon->query($sql);
$res2 = $objCon->query($sql2);

$user = $res2->fetch_object();
$user2 = $res->fetch_object();
if (!isset($_SESSION['user']))
	header("Location: ../../login.php?x=2"); #x=2 debe estar logueadoss
if ($user2->Admin == "no") {
	header("Location: ../../usuario/Vista/index.php?x=1"); #x=1 el usuario no tiene permisos para acceder a esta area
}
if ($user->Documento_emp == $_SESSION['user']) {
	header("Location: empleados.php?x=7"); #x=7 no se puede editar su perfil
}
				...
				<div class="container-fluid">
					...
					<div class="offcanvas offcanvas-start bg-dark" style="color:white;" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
						<div class="offcanvas-header bg-light" style="color:black;">
							...
							<h3><?php echo $user->Nombre_emp ?></h3>
			...
			<article class="col-xs-12 col-sm-10 col-md-9 col-lg-9 col-xl-10 img-fluid" id="fondoCentral">
				<div class="container-fluid">
					...
					<div class="container">
						...
						<h3 class="offset-lg-1">Modificar Empleado:</h3>
						<h4 class="offset-lg-1">Ingresar Datos:</h4><br />
								...
								<div class="card" style="border:1px solid">
									...
									<div class="card-body" style="background:#B2E666;">
										<div class="row mb-3">
											...
											<input type="hidden" name="id" value="<?php echo $user->id_empleado ?>">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-4">
												<label for="Nombre" class="form-label">Nombres:</label>
												<input class="form-control" type="text" name="Nombre" value="<?php echo $user->Nombre_emp ?>" required autocomplete="off">
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-4">
												<label for="Apellido" class="form-label">Apellidos:</label>
												<input class="form-control" type="text" name="Apellido" value="<?php echo $user->Apellido_emp ?>" required autocomplete="off">
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-4 col-lg-4 offset-lg-1 col-xl-3">
												<label for="Documento" class="form-label">Documento:</label>
												<input class="form-control" type="hidden" name="Documento" value="<?php echo $user->Documento_emp ?>" required autocomplete="off">
												<input class="form-control" type="text" value="<?php echo $user->Documento_emp ?>" required autocomplete="off" disabled>
											</div>
											<div class="col-xs-12 col-sm-4 col-lg-3 col-xl-3">
												<label for="Edad" class="form-label">Edad:</label>
												<input class="form-control" type="number" name="Edad" value="<?php echo $user->Edad_emp ?>" required autocomplete="off">
											</div>
											<div class="col-xs-12 col-sm-4 col-lg-3 col-xl-3">
												<label for="Salario" class="form-label">Salario:</label>
												<input class="form-control" type="number" name="Salario" value="<?php echo $user->Salario_emp ?>">
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-4">
												<label for="Direccion" class="form-label">Direccion:</label>
												<input class="form-control" type="text" name="Direccion" value="<?php echo $user->Direccion_emp ?>" required autocomplete="off">
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-4">
												<label for="Correo" class="form-label">Correo:</label>
												<input class="form-control" type="email" name="Correo" value="<?php echo $user->Correo_emp ?>" required autocomplete="off">
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-4 offset-lg-2 col-xl-3 offset-xl-1">
												<label for="Telefono" class="form-label">Telefono:</label>
												<input class="form-control" type="text" name="Telefono" value="<?php echo $user->Telefono_emp ?>" required autocomplete="off">
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-4 col-xl-3">
												<label for="Horario" class="form-label">Horario:</label>
												<input class="form-control" type="text" name="Horario" value="<?php echo $user->Horario_emp ?>" required autocomplete="off">
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-3">
												<label for="Area" class="form-label">Area:</label>
												<input class="form-control" type="text" name="Area" value="<?php echo $user->Area_emp ?>" required autocomplete="off">
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-5">
												<label for="Profesion" class="form-label">Profesion:</label>
												<input class="form-control" type="text" name="Profesion" value="<?php echo $user->Profesion_emp ?>" required autocomplete="off">
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-3">
												<label for="Dias_descanso" class="form-label">Dias de descanso:</label>
												<input class="form-control" type="text" name="Dias_descanso" value="<?php echo $user->Diasdes_emp ?>" required autocomplete="off">
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-7">
												<label for="Funciones" class="form-label">Funciones:</label>
												<textarea name="Funciones" class="form-control" required autocomplete="off"><?php echo $user->Funciones_emp ?>
						    </textarea>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-3">
												...
												<input name="Contraseña" class="form-control" type="text" value="<?php echo $user->Contraseña_usuario ?>" required autocomplete="off">
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-3">
												<label for="Educativo" class="form-label">Nivel Educativo:</label>
												<input name="Educativo" class="form-control" type="text" value="<?php echo $user->NivelEducativo_emp ?>" required autocomplete="off">
											</div>
											<div class="col-xs-12 col-sm-6 col-lg-5 col-xl-3">
												<label for="Cargo" class="form-label">Cargo:</label>
												<input name="Cargo" class="form-control" type="text" value="<?php echo $user->Cargo_emp ?>" required autocomplete="off">
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-4">
											...
											<div class="col-xs-12 col-sm-6 col-lg-5 offset-lg-1 col-xl-4">
												...
												<select name="Estado" class="form-select" required autocomplete="off">
													<option value="Activo" selected>Activo</option>
													<option value="Inactivo">Inactivo</option>
												</select>
												<input type="hidden" name="elim" value="<?php echo $_SESSION['user'] ?>">
								                <input type="hidden" name="doc" value="<?php echo $user->Documento_emp ?>">
											</div>
										</div>
										<br />
									</div>
									<br />
									<center>
										<button class="btn btn-info btn-lg" type="submit" name="submit">Modificar</button>
									</center>
									<br />
								</div>
							</fieldset>
